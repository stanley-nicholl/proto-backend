exports.seed = function(knex, Promise) {
  ...
  return knex('users').insert([
    ...
    { id: 3, first_name: 'David', last_name: 'Bowie', position: 'Director of Dance', email: 'spaceOddity@dancewith.us', image: `https://i1.wp.com/ajournalofmusicalthings.com/wp-content/uploads/2016/11/David-Bowie-Aladdin-Sane.jpg?fit=1520%2C855`, admin: false, prototype_id: 2 },
    { id: 4, first_name: 'Adam', last_name: 'West', position: 'Chief Fear & Justice Officer', email: 'thebatman@gothamunderground.bat', image: `https://4.bp.blogspot.com/--4Y7JD-SgVQ/WT6q5StejbI/AAAAAAAAC0A/rkAaipDsSe8RFEI6oLXr8p6hqbha7PGpQCLcB/s1600/BatmanWithBomb.jpg`, admin: false, prototype_id: 1 },
