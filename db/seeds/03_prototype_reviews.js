exports.seed = function(knex, Promise) {
  ...
  return knex('prototype_reviews').insert([
    ...
    { id: 2, prototype_id: 1, user_id: 1, feedback: 'I like the direction of where this is going. Needs to enable other communication methods beyond text.', rating: 4, request: 'review with Brian Delmico' }
  ])
  .then(() => {
