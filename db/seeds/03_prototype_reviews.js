exports.seed = function(knex, Promise) {
  ...
  return knex('prototype_reviews').insert([
    { id: 1, prototype_id: 1, user_id: 1, painGain: true, simple: false, changeRequest: 'I like the direction of where this is going. Needs to enable other communication methods beyond text.', nextSteps: 'review with Brian Delmico' },
