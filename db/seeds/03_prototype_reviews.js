exports.seed = function(knex, Promise) {
  ...
  return knex('prototype_reviews').insert([
    { id: 1, prototype_id: 1, user_id: 2, painGain: true, simple: true, changeRequest: 'I like the direction of where this is going. Needs to enable other communication methods beyond text.', nextSteps: 'Review with Brian Delmico' },
